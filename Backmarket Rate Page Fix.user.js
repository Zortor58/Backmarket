...
(function() {
    ...
    if(templates != null) {
        ...
        $('#selectTemplates')
            .find('#returnProd')
            .append('<option value="Message Free">Message Free</option>').val("6");
        $('#selectTemplates')
            .find('#returnProd')
            .append('<option value="iCloud après photos">iCloud après photos</option>').val("7");
        ...
        $('#selectTemplates')
            .find('#sav')
            .append('<option value="Envoyé">Envoyé</option>').val("6");
...
=======
                    $("#id_message").val("Bonjour,\n\nAvant de vous envoyer la procédure à suivre pour un retour de votre appareil dans de bonnes conditions. Nous vous demanderons de nous fournir 6 photos de ce dernier :\n\n- Une photo de face (allumé sur la page où figure l'IMEI (Appareils Apple: Paramètres -> Général -> Informations -> IMEI ; Android & Autres: Paramètres Réglages -> taper IMEI dans la barre de recherche). Bien évidemment, nous comprendrons qu'il sera impossible de voir l'IMEI dans le cas où vous souhaiteriez envoyer un mobile ne s'allumant plus. Veuillez donc nous fournir une photo de l'écran éteint si c'est le cas. Merci de noter que nous demandons une photo et non une capture d’écran.\n- Une photo de l'arrière\n- Une photo de chaque tranche (avec coins visibles) soit 4 photos\n\nNous vous remercions pour le soin apporté à ces photos afin qu'elles soient claires.\n\nVous pouvez les faire parvenir à l'adresse sav@mobilerachat.com dans le cas où vous n'arriveriez pas à les envoyer sur la plateforme. Merci de préciser votre nom de famille si votre adresse mail ne le contient pas ou un numéro de commande.\n\nDe plus, nous vous demanderons de retirer les comptes utilisateurs de votre appareil (iCloud ou Google). Voici la procédure à suivre si vous ne savez pas comment faire :\n\nPour Apple : Aller sur le site pour prendre connaissance de la démarche :\nConcernant les appareils qui s'allument et qui sont fonctionnels, il vous suffira de vous rendre dans réglages -> cliquer sur le tout premier onglet qui affiche le nom donné à votre compte -> cliquer sur déconnexion -> choisir les préférences de sauvegarde et valider en faisant 'se déconnecter' en haut à droite de l'écran\nPour les appareils impossibles à allumer ou à utiliser : http://www.andromac.fr/questions-frequentes/comment-desactiver-la-fonction-localiser-mon-iphone-si-mon-iphone-ne-sallume-plus\nPour Android : Aller sur le site pour prendre connaissance de la démarche : http://www.prodigemobile.com/tutoriel/supprimer-compte-google-android/\n\nMerci de prendre connaissance du fait que tout compte iCloud (appareils Apple) peut être retiré via un ordinateur, un compte iCloud relié à un appareil qui ne s'allumerait plus ou ne fonctionnerait plus peut donc être retiré.\nAttention, une demande d'effacement de l'appareil ne supprime pas le compte iCloud. Si c'est ce que vous avez fait, il vous faudra annuler la demande d'effacement et suivre la procédure dans le lien donné plus haut.\nA l'inverse, nous sommes tout à fait conscient qu'un appareil Android non fonctionnel ne pourra voir son compte Google retiré.\n\nEnfin, nous serons dans l'obligation d'attendre votre confirmation écrite quant au retrait du compte iCloud, ce que nous vérifierons avant de vous fournir la procédure de retour.\n\nAucune procédure de retour ne sera fournie pour un appareil bloqué par un compte iCloud. De la même manière, tout appareil Android bloqué dont le compte Google aurait pu être retiré à l'envoi ne sera pas diagnostiqué dans l'attente du règlement des frais de retour vers son propriétaire pour déblocage.\n\nCordialement,\nLe service client MobileRachat.");
>>>>>>> ff2e6c1a79266fe4b95baf8dfcd135485a11ff23
                    break;
                case 'Retour Bon Chronopost':
                    $("#id_message").val("Bonjour,\n\nMerci de lire le mail attentivement, jusqu'au bout et de suivre la totalité des indications.\n\nVoici les étapes à suivre pour nous retourner le produit défectueux afin d’obtenir la réparation ou l’échange de ce dernier dans le cas où les réparations seraient impossibles :\n\n1. Veuillez trouver ci-joint le bon prépayé Chronopost qu'il vous faudra coller sur le colis lors de l'envoi (vous le trouverez en pièce jointe en vous connectant à votre compte et vous rendant dans notre échange.)\n\n2. Pensez à bien joindre un document mentionnant votre nom, adresse e-mail, le bon de commande ou de livraison ou votre facture ainsi que le détail des pannes constatées. Ce petit bout de papier (ou paragraphe sur un papier déjà existant) facilitera et donc accélérera la prise en charge par nos techniciens.\n\n3. Sauvegardez vos données personnelles.\nPour iPhone, copiez/collez ce lien :  https://support.apple.com/fr-fr/HT203977\nPour Samsung, copiez/collez ce lien : http://www.samsung.com/fr/support/usefulsoftware/KIES/\nPour les autres marques, rendez-vous sur les sites des constructeurs.\n\n4. Ne renvoyez pas votre carte SIM et/ou carte SD, vous devez la/les garder.\n\n5. Emballez bien le produit et les accessoires et mettez-les dans un carton ou dans la  boite reçu avec l’appareil.\nLes accessoires ne nous seront utiles que si ces derniers sont défectueux ou liés à la panne de l’appareil (panne de chargement, batterie ou écouteurs par exemple)\n\n6. Répondez à ce mail en envoyant votre numéro de suivi, une fois le colis posté. Merci de nous fournir votre adresse de retour si elle est différente.\n\n7. Réinitialiser votre téléphone avec les paramètres d'usine.\nPour iPhone : Aller dans Réglages --> Aller dans la section iCloud --> Désactiver l'option 'localiser mon iPhone --> Saisir l'identifiant Apple Client\nPour Android : Aller dans Paramètres --> Allez dans la section Sauvegarder et réinitialiser (OU Gestion globale/Réinitialisation selon la version Android) --> Sélectionner 'Réinitialiser toutes les données' et confirmer\nPour Windows phone : Aller dans Paramètres --> Appuyez sur le sous-menu 'À propos de' -->\nDéfilez l'écran de bas en haut et appuyez sur 'Réinitialiser votre téléphone'\n\nLa remise en main propre est impossible.\n\nAucun appareil de remplacement n'est fourni pendant le retour en SAV.\n\nCependant, si la panne ne rentre pas dans la garantie (oxydation, chute...), nous ne pourrons pas effectuer de réparation et vous renverrons votre téléphone à vos frais sans être intervenu d’aucune manière.\n\nN’hésitez pas à nous recontacter si vous avez des questions.\nEn espérant avoir répondu à toutes vos attentes,\n\nCordialement,\nLe service client MobileRachat.");
                    break;
                case 'Rétractation':
                    $("#id_message").val("Bonjour,\n\nMerci de lire le mail attentivement, jusqu'au bout et de suivre la totalité des indications.\n\nVoici les étapes à suivre pour nous retourner le produit dans le cadre de la rétractation et obtenir le remboursement :\n\n1. Expédiez le colis depuis La Poste ou le transporteur de votre choix à l'adresse ci-dessous (un envoi suivi est fortement conseillé) :\n\nSociété LEGSM\n10 Rue Lebouis\n75014 Paris\n\n2. Pensez à bien joindre un document mentionnant votre nom, adresse e-mail, le bon de commande et le détail des pannes constatées. Ce petit bout de papier (ou paragraphe sur un papier déjà existant) facilitera et donc accélérera la prise en charge par nos techniciens.\n\n3. Merci de compléter et joindre le bon de rétractation dont l'exemple est fourni en pièce jointe. Sans cela, votre demande de rétractation ne sera pas prise en compte.\n4. Nous vous demanderons de retirer les comptes utilisateurs de votre appareil (iCloud ou Google).\nVoici la procédure à suivre si vous ne savez pas comment faire (il vous sera inutile de lire la suite si votre appareil n’a absolument pas été initialisé) :\n\nPour Apple : Aller sur le site pour prendre connaissance de la démarche :\nConcernant les appareils qui s'allument et qui sont fonctionnels, il vous suffira de vous rendre dans réglages -> cliquer sur le tout premier onglet qui affiche le nom donné à votre compte -> cliquer sur déconnexion -> choisir les préférences de sauvegarde et valider en faisant 'se déconnecter' en haut à droite de l'écran\nPour les appareils impossibles à allumer ou à utiliser : http://www.andromac.fr/questions-frequentes/comment-desactiver-la-fonction-localiser-mon-iphone-si-mon-iphone-ne-sallume-plus\nPour Android : Aller sur le site pour prendre connaissance de la démarche : http://www.prodigemobile.com/tutoriel/supprimer-compte-google-android/\n\nMerci de prendre connaissance du fait que tout compte iCloud (appareils Apple) peut être retiré via un ordinateur, un compte iCloud relié à un appareil qui ne s'allumerait plus ou ne fonctionnerait plus peut donc être retiré.\nAttention, une demande d'effacement de l'appareil ne supprime pas le compte iCloud. Si c'est ce que vous avez fait, il vous faudra annuler la demande d'effacement et suivre la procédure dans le lien donné plus haut.\nA l'inverse, nous sommes tout à fait conscient qu'un appareil Android non fonctionnel ne pourra voir son compte Google retiré.\nAucune demande de rétractation ne sera satisfaite pour un appareil bloqué par un compte utilisateur qu’il soit de type iCloud ou Google.\n\nLa remise en main propre est impossible.\n\nSi l’appareil ne rentre pas dans la garantie (oxydation, modification logicielle ou appareil dégradé au regard de l’état dans lequel il a été vendu,...), nous ne pourrons pas effectuer de remboursement.\n\nN’hésitez pas à nous recontacter si vous avez des questions.\nEn espérant avoir répondu à toutes vos attentes,\n\nCordialement,\nLe service client MobileRachat.");
                    break;
                case 'Rétractation Bon Chrono':
                    $("#id_message").val("Bonjour,\n\nMerci de lire le mail attentivement, jusqu'au bout et de suivre la totalité des indications.\n\nVoici les étapes à suivre pour nous retourner le produit dans le cadre de la rétractation et obtenir le remboursement :\n\n1. Veuillez trouver ci-joint le bon prépayé Chronopost qu'il vous faudra coller sur le colis lors de l'envoi (vous le trouverez en pièce jointe  en vous connectant à votre compte et vous rendant dans notre échange.)\n\n2. Pensez à bien joindre un document mentionnant votre nom, adresse e-mail, le bon de commande et le détail des pannes constatées. Ce petit bout de papier (ou paragraphe sur un papier déjà existant) facilitera et donc accélérera la prise en charge par nos techniciens.\n\n3. Merci de compléter et joindre le bon de rétractation dont l'exemple est fourni en pièce jointe. Sans cela, votre demande de rétractation ne sera pas prise en compte.\n\n4. Nous vous demanderons de retirer les comptes utilisateurs de votre appareil (iCloud ou Google).\nVoici la procédure à suivre si vous ne savez pas comment faire (il vous sera inutile de lire la suite si votre appareil n’a absolument pas été initialisé) :\n\nPour Apple : Aller sur le site pour prendre connaissance de la démarche : \nConcernant les appareils qui s'allument et qui sont fonctionnels, il vous suffira de vous rendre dans réglages -> cliquer sur le tout premier onglet qui affiche le nom donné à votre compte -> cliquer sur déconnexion -> choisir les préférences de sauvegarde et valider en faisant 'se déconnecter' en haut à droite de l'écran\nPour les appareils impossibles à allumer ou à utiliser : http://www.andromac.fr/questions-frequentes/comment-desactiver-la-fonction-localiser-mon-iphone-si-mon-iphone-ne-sallume-plus\nPour Android : Aller sur le site pour prendre connaissance de la démarche : http://www.prodigemobile.com/tutoriel/supprimer-compte-google-android/\n\nMerci de prendre connaissance du fait que tout compte iCloud (appareils Apple) peut être retiré via un ordinateur, un compte iCloud relié à un appareil qui ne s'allumerait plus ou ne fonctionnerait plus peut donc être retiré.\nAttention, une demande d'effacement de l'appareil ne supprime pas le compte iCloud. Si c'est ce que vous avez fait, il vous faudra annuler la demande d'effacement et suivre la procédure dans le lien donné plus haut.\nA l'inverse, nous sommes tout à fait conscient qu'un appareil Android non fonctionnel ne pourra voir son compte Google retiré.\nAucune demande de rétractation ne sera satisfaite pour un appareil bloqué par un compte utilisateur qu’il soit de type iCloud ou Google.\n\nLa remise en main propre est impossible.\n\nSi l’appareil ne rentre pas dans la garantie (oxydation, modification logicielle ou appareil dégradé au regard de l’état dans lequel il a été vendu,...), nous ne pourrons pas effectuer de remboursement.\n\nN’hésitez pas à nous recontacter si vous avez des questions.\nEn espérant avoir répondu à toutes vos attentes,\n\nCordialement,\nLe service client MobileRachat.");
                    break;
                case 'Message Free':
                	$("#id_message").val("Bonjour,\n\nL'appareil n'est pas volé, le premier propriétaire à simplement des factures impayées chez Free ou n'a pas restitué le mobile qu'il avait loué et dont il n'était pas propriétaire. Nous effectuons toutes les démarches afin de nous assurer qu'un appareil n'apparaisse pas sur les listes nationales de polices des appareils volés, avant le rachat de ce dernier. Free a donc procédé au greylistage de l'appareil contrairement à la loi et aux accords passés avec ses clients qui précisent des poursuites contre le client et non l'appareil de ce dernier en cas de manquement.\n\nNous comprenons que votre situation est gênante, nous vous proposons donc de nous transmettre 6 photos de l'appareil (face, dos et une de chaque tranche/coin) afin de déterminer l'état esthétique de ce dernier. Suite à cela, nous pourrons vous fournir un bon de retour pour que nous puissions prendre en charge votre appareil. Cette prise en charge se traduira par un échange vers un modèle présentant un état esthétique identique à celui reçu ou par un remplacement de carte mère s'il est trop abîmé, cassé, oxydé, tordu ou impossible à remplacer faute de stock.\n\nVeuillez toutefois nous excuser pour la gêne occasionnée par Free.\n\nCordialement,\nLe service client MobileRachat");
                	break;
                case 'iCloud après photos':
                	$("#id_message").val("Bonjour,\n\nNous vous remercions pour les photos transmises et bien reçues.\n\nCependant, il s'avère que votre compte iCloud est toujours présent sur l'appareil. Pourriez-vous le retirer afin que nous puissions vous transmettre le bon de retour ?\n\nPetit rappel : http://www.andromac.fr/questions-frequentes/comment-desactiver-la-fonction-localiser-mon-iphone-si-mon-iphone-ne-sallume-plus\n\nEn vous remerciant,\nCordialement,\nLe service client MobileRachat");
                	break;
                case 'Réinitialisation Apple jusqu\'au 6S':
                    $("#id_message").val("Bonjour,\n\nAvant de procéder à un retour de l'appareil, il se peut qu'il s'agisse d'une simple panne logicielle.\nPour en être sûr, pouvez-vous essayez de restaurer votre téléphone ?\nPour cela, veuillez connecter le mobile à votre ordinateur au travers du logiciel Apple iTunes.\nAppuyez simultanément sur les boutons verrouiller/déverrouiller ainsi que le bouton HOME.\nTenez la position assez longtemps pour voir apparaître le logo iTunes sur votre téléphone (environ 20 secondes). A présent, vous avez la possibilité de procéder à la restauration complète des paramètres d'usine de l'appareil. Pensez à sauvegarder vos données avant, car cette manipulation va effacer tout ce qui se trouve sur l'appareil.\nMerci de tester votre appareil après restauration sans réinstaller quoique ce soit en premier lieu.\nEffectuez si possible les dernières mises à jour.\nSi après cette manipulation vous rencontrez toujours le même problème, merci de nous recontacter pour que nous procédions au retour du téléphone.\n\nCordialement,\nLe service client MobileRachat");
                    break;
